...
.config(function($stateProvider, $urlRouterProvider, $ionicConfigProvider) {
  ...
  .state('app.Scan QR', {
    ...
    views: {
      'menuContent': {
        templateUrl: "views/app/Scan QR/Scan QR.html"
      }
    }
  })
  ...
  .state('app.maps', {
    ...
    views: {
      'menuContent': {
        templateUrl: "views/app/Scan QR/maps.html",
        controller: 'MapsCtrl'
      }
    }
  })
  ...
  .state('app.image-picker', {
    url: "/Scan QR/image-picker",
    views: {
      'menuContent': {
        templateUrl: "views/app/Scan QR/image-picker.html",
